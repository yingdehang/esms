		...
		.use(
				...
				function() {
					...
					table.render({
						...
						url : '/statisticalSystem/getRunningwaterlist',
						id : 'runningwaterlist',
						height : '500px',
						cellMinWidth : '120',
						where : {
					...
					table
							.on(
									'tool(runningwaterlist)',
									function(obj) {
										var data = obj.data;
										if (obj.event === 'detail') {
											window.location.href = "/statisticalSystem/toSeeDetailsHtml?month="
													+ data.clearingTime
													+ "&areaId="
													+ areaId
													+ "&provinceId="
					...
					active = {
						...
						batchExport : function() {
							...
							if (len > 0) {
								...
								window.location.href = "/statisticalSystem/getRunningwaterDaochu?indexs="
